...
<body onLoad="window.print()">
    <div style="margin:0 auto; width:1000px; border:1px solid #000;">
        ...
        <table width="100%">
            ...
            <?php
            $sql1 = "SELECT * FROM thongtinsanpham ttsp, thongtinkhachang ttkh WHERE ttsp.IDKhachHang= ttkh.IDKhachHang and ttkh.IDKhachHang=$idhd;";
        ...
        <table width="95%" style="border-collapse:collapse; margin-left: 20px; margin-right: 20px;">
            ...
            $sql = "SELECT * FROM thongtinsanpham ttsp, thongtinkhachang ttkh where ttsp.IDKhachHang  = ttkh.IDKhachHang and ttkh.IDKhachHang = $idhd;";
